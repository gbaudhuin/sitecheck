                    ...
                    self.getAnotherToken(cancellationToken, (ivs2) => {
                        ...
                        if (ivs2 && ivs2.length > 0) {
                            for (let iv1 of self.ivs) {
                                ...
                                if (csrfValue1) {
                                    for (let iv2 of ivs2) {
                                        if (iv1.isSameVector(iv2)) {
                                            ...
                                            // TODO : que fait-on s'il y a plusieurs champs qui ressemblent � des token CSF ?
                                        }
                                    }
                                }
                                ...
                                // - nouvelle �tape de check : v�rifier qu'une session ne peut pas utiliser le token csrf d'une autre session : https://blog.qualys.com/securitylabs/2015/01/14/do-your-anti-csrf-tokens-really-protect-your-applications-from-csrf-attack
                                //
